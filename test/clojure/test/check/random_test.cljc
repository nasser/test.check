...
(def gen-seed
  (let [gen-int (gen/choose 0 #?(:clj Integer/MAX_VALUE :cljr Int32/MaxValue))]
    (gen/fmap (fn [[s1 s2]]
...
#?(:clj (when (try (Class/forName "java.util.SplittableRandom") ;;Class/forName not owrking in .net
